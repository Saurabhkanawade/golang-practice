...
type Student struct {
	...
	Dob    null.String `boil:"dob" json:"dob,omitempty" toml:"dob" yaml:"dob,omitempty"`
...
var (
	studentAllColumns            = []string{"id", "name", "gender", "dob"}
	studentColumnsWithoutDefault = []string{}
	studentColumnsWithDefault    = []string{"id", "name", "gender", "dob"}
