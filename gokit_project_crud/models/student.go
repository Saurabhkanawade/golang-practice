...
type Student struct {
	...
	College null.String `boil:"college" json:"college,omitempty" toml:"college" yaml:"college,omitempty"`
...
var StudentWhere = struct {
	...
	College whereHelpernull_String
	Gender  whereHelpernull_String
}{
	ID:      whereHelperint64{field: "\"student\".\"id\""},
	Name:    whereHelpernull_String{field: "\"student\".\"name\""},
	College: whereHelpernull_String{field: "\"student\".\"college\""},
...
var (
	studentAllColumns            = []string{"id", "name", "college", "gender"}
	studentColumnsWithoutDefault = []string{"id"}
	studentColumnsWithDefault    = []string{"name", "college", "gender"}
